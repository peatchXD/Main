...
-- Toggle เปิด/ปิด Admin UI
Section:NewToggle("Open Admin UI", "เมนูเสกของแอดมิน", function(AdminGui)
    local Admin_Menu = game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("AdminV2")
    if Admin_Menu then
        Admin_Menu.Enabled = AdminGui
    else
        warn("ไม่พบ AdminV2 ใน PlayerGui")
    end
end)
