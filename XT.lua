...
local Section = Tab:NewSection("Create Things")

Section:NewTextBox("Cast A Spell (1)", " ",function(ADMIN)
    local args = {
        [1] = (ADMIN),
        [2] = 0,
        [3] = (ADMIN),
    ...
    game:GetService("Players").LocalPlayer.PlayerGui.FoodProcess.Remote.RemoteEvent:FireServer(unpack(args))
end)

Section:NewTextBox("Cast A Spell (100000)", " ",function(ADMINS)
    local args = {
        [1] = (ADMINS),
        [2] = 0,
        [3] = (ADMINS),
...
game:GetService("ReplicatedStorage").Rebuild.Remote.Event:FireServer(unpack(args))
end)
...
Section:NewButton("ATM (1)", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(688.28772, 8.86722946, 913.674438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)

------------------------------------------------------------------------------------------

Section:NewButton("ATM (2)", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(688.28772, 8.86722946, 852.674438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)

------------------------------------------------------------------------------------------

Section:NewButton("ATM (3)", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(692.742737, 9.24212742, -1032.20764, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)

------------------------------------------------------------------------------------------

Section:NewButton("ATM (4)", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(752.829712, 9.24212646, -1032.68518, 0, 0, 1, 0, 1, -0, -1, 0, 0)
end)
...
Section:NewToggle("Auto Farm Logan", " ",function(Logan)
    _G.Logan = (Logan) 
end)
...
spawn(function()
	while wait() do
		if _G.Logan then
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1476.58899, 8.92184448, 3034.97778, 0, 0, 1, 0, 1, -0, -1, 0, 0)
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1385.08862, 8.92184448, 3048.40503, 0, 0, 1, 0, 1, -0, -1, 0, 0)
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1312.72205, 8.92184448, 3048.40503, 0, 0, 1, 0, 1, -0, -1, 0, 0)
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1350.86646, 8.92184353, 3129.89185, -1, 0, 0, 0, 1, 0, 0, 0, -1)
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1426.30762, 8.92184353, 3131.68945, 0, 0, -1, 0, 1, 0, 1, 0, 0)
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1386.40344, 8.92184353, 3202.95996, 0, 0, -1, 0, 1, 0, 1, 0, 0)
        wait(0.5)
		else
		end
	end
...
Section:NewToggle("Auto Farm Shark", " ",function(Shark)
    _G.Shark = (Shark) 
    Sharks = (Shark)
end)
...
spawn(function()
	while wait() do
		if _G.Shark then
      local tpcows = game:GetService("Workspace").SharkAnimals.Shark --copypath มา
      local part = tpcows:FindFirstChild("HumanoidRootPart") --ชื่อไอสัส
...
Section:NewToggle("Auto Farm Wood (Required: Axe)", " ",function(Wood)
    _G.Wood = (Wood) 
    Axes = (Wood)
end)
...
spawn(function()
	while wait() do
		if _G.Wood then
      local tpcows = game:GetService("Workspace").Collect.Stickwood --copypath มา
      local part = tpcows:FindFirstChild("Part") --ชื่อไอสัส
...
Section:NewButton("None", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new()
end)
...
Section:NewButton("Safe", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1659.02832, 21.6059341, 846.029297, -0.99998033, 6.62216877e-08, -0.00627021911, 6.60047377e-08, 1, 3.48067992e-08, 0.00627021911, 3.43922508e-08, -0.99998033)
end)

------------------------------------------------------------------------------------------

local Section = Tab:NewSection("Treasure Taken")

Section:NewButton("Treasure Taken", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-4741.0708, 99.5113068, -6460.625, 0.97754395, 0.0932822227, -0.188961074, -0.120694265, 0.98288548, -0.139172599, 0.172744766, 0.158853844, 0.972072363)
end)

------------------------------------------------------------------------------------------

local Section = Tab:NewSection("Prisoner Spawn")

Section:NewButton("Prisoner Spawn", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2262.25195, 6.00001192, -1581.828, 0, 0, 1, 0, 1, -0, -1, 0, 0)
end)
...
Section:NewButton("NPC SHOP", "", function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(732.527039, 9.00419903, -977.814575, -0.0382347442, 2.37127527e-08, -0.99926877, 2.20165575e-08, 1, 2.28876917e-08, 0.99926877, -2.11253539e-08, -0.0382347442)
end)
